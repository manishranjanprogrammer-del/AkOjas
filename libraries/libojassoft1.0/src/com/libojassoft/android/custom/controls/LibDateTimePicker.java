...
public class LibDateTimePicker extends RelativeLayout {
	// DatePicker reference 
		...
		public LibDateTimePicker(Context context, AttributeSet attrs) {
			this(context, attrs, 0);
		}
		
		public LibDateTimePicker(Context context, AttributeSet attrs, int defStyle) {
...
//			inflater.inflate(R.layout.datetimepicker, this, true);
			...
			myPickerView = inflator.inflate(R.layout.lib_datetimepicker, null);
...
//				_hour = Integer.parseInt(_etHour.getText().toString());
		...
		//Added by hukum to init date
		public void initDateElements(int mYear, int mMonth, int mDay) {
			this.year = mYear;
			this.month = mMonth;
			this.day = mDay;
		}

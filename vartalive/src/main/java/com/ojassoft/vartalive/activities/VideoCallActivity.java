...
import com.ojassoft.vartalive.rtc.EngineConfig;
import com.ojassoft.vartalive.stats.StatsManager;
import com.ojassoft.vartalive.utils.PrefManager;
...
public class VideoCallActivity extends AppCompatActivity implements VolleyResponse, View.OnClickListener, View.OnTouchListener {
   // private final String appId = "388e87b2ab364a1fa6a7837df4a9c988";
    ...
    SurfaceView localSurfaceView, remoteSurfaceView;
    ...
    private void initConfig() {
        ...
        mGlobalConfig.setVideoDimenIndex(pref.getInt(
                com.ojassoft.vartalive.utils.Constants.PREF_RESOLUTION_IDX, com.ojassoft.vartalive.utils.Constants.DEFAULT_PROFILE_IDX));

        boolean showStats = pref.getBoolean(com.ojassoft.vartalive.utils.Constants.PREF_ENABLE_STATS, false);
        mGlobalConfig.setIfShowVideoStats(showStats);
        mStatsManager.enableStats(showStats);

        mGlobalConfig.setMirrorLocalIndex(pref.getInt(com.ojassoft.vartalive.utils.Constants.PREF_MIRROR_LOCAL, 0));
        mGlobalConfig.setMirrorRemoteIndex(pref.getInt(com.ojassoft.vartalive.utils.Constants.PREF_MIRROR_REMOTE, 0));
        mGlobalConfig.setMirrorEncodeIndex(pref.getInt(com.ojassoft.vartalive.utils.Constants.PREF_MIRROR_ENCODE, 0));
    }
    ...
    private void setLocalVideoViewContainer(float width,float height) {
        ...
        flVideoCallCanvasSelf.setBackground(ContextCompat.getDrawable(context, R.drawable.bg_white_rounded));
...
//            agoraEngine.setClientRole(2, clientRoleOptions);
    ...
    private void configVideo() {
        VideoEncoderConfiguration configuration = new VideoEncoderConfiguration(
                com.ojassoft.vartalive.utils.Constants.VIDEO_DIMENSIONS[config().getVideoDimenIndex()],
                VideoEncoderConfiguration.FRAME_RATE.FRAME_RATE_FPS_15,
                VideoEncoderConfiguration.STANDARD_BITRATE,
                VideoEncoderConfiguration.ORIENTATION_MODE.ORIENTATION_MODE_FIXED_PORTRAIT
        );
        configuration.mirrorMode = com.ojassoft.vartalive.utils.Constants.VIDEO_MIRROR_MODES[config().getMirrorEncodeIndex()];
        ...
        if (local) {
            agoraEngine.setupLocalVideo(
                    new VideoCanvas(
                            ...
                            0,
                            com.ojassoft.vartalive.utils.Constants.VIDEO_MIRROR_MODES[config().getMirrorLocalIndex()]
                    )
            );
        } else {
            agoraEngine.setupRemoteVideo(
                    new VideoCanvas(
                            ...
                            VideoCanvas.RENDER_MODE_HIDDEN,
                            uid,
                            com.ojassoft.vartalive.utils.Constants.VIDEO_MIRROR_MODES[config().getMirrorRemoteIndex()]
                    )
            );
        }
        return surface;

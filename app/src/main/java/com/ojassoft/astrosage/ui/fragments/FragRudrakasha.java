 ...
 */
public class FragRudrakasha extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        data = ((ActAstroShop) getActivity()).data.get(4);
        if (data != null && data.getRudraksha().size() > 0) {

            arrayListdata = data.getRudraksha();

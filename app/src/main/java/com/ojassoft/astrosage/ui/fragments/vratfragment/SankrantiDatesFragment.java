...
/**
 * Created by ojas-02 on 18/1/18.
 */

public class SankrantiDatesFragment extends Fragment implements OnRefreshListener {
    ...
    public static Fragment newInstance(String panchang) {
        ...
        SankrantiDatesFragment f = new SankrantiDatesFragment();
        Bundle b = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.sankranti_dates_fragment, container, false);
        mRecyclerView = (RecyclerView) view.findViewById(R.id.my_sankranti_recycler_view);
        ...
        (((ActYearlyVrat) activity).beanPlace) = (((ActYearlyVrat) activity).beanPlace);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((ActYearlyVrat) activity).downloadDataWhenChangeInDate(CGlobalVariables.sankrantiVratUrl, ((ActYearlyVrat) activity).year, (((ActYearlyVrat) activity)).cityId, true);
        ...
        topAdImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CUtils.googleAnalyticSendWitPlayServie(activity,
                        ...
                        CGlobalVariables.GOOGLE_ANALYTIC_SLOT_57_Add, null);
                CUtils.fcmAnalyticsEvents(CGlobalVariables.GOOGLE_ANALYTIC_SLOT_57_Add, CGlobalVariables.FIREBASE_EVENT_ITEM_CLICK, "");

                CUtils.createSession(activity, "S57");
    ...
    private void getData() {
        ...
        try {
            ...
            if (result != null && !result.equals("")) {
                ...
                topAdData = CUtils.getSlotData(adList, "57");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        switch (requestCode) {
            case SUB_ACTIVITY_PLACE_SEARCH:
                if (resultCode == activity.RESULT_OK) {
                    ...
                    //isChecked = CUtils.getUsersCheckedDefaultCityForVrat(activity);
                    //downloadDataWhenChangeInDate(((ActYearlyVrat) activity).year, (((ActYearlyVrat) activity).beanPlace).getCityId());
                    ((ActYearlyVrat) activity).downloadDataWhenChangeInDate(CGlobalVariables.sankrantiVratUrl, ((ActYearlyVrat) activity).year, cityId, true);
    ...
    public void onRefresh() {
        ...
        ((ActYearlyVrat) activity).downloadDetails(CGlobalVariables.sankrantiVratUrl, ((ActYearlyVrat) activity).year, (((ActYearlyVrat) activity)).cityId, false);
    }
}

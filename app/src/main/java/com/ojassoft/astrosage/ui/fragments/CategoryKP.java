...
public class CategoryKP extends Fragment {
    ...
    public static CategoryKP newInstance(boolean isAdTitleAdded, int adPosition) {
        Bundle bundle = new Bundle();
        bundle.putBoolean("isAdTitleHaseBeenGivenTOTabs", isAdTitleAdded);
        bundle.putInt("localAdvertismentPosition", adPosition);
        CategoryKP appViewFragment = new CategoryKP();
    ...
    public void onAttach(Activity activity) {
        ...
        iCategoryKP = (ICategoryKP) activity;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        moduleNameList = getActivity().getResources().getStringArray(R.array.module_board_kp_list);
        ...
        llCustomAdv.addView(CUtils.getCustomAdvertismentView(activity, false, ((BaseInputActivity) getActivity()).mediumTypeface,"SKP"));
            ...
            if (categoryItem.index1 > -1) {
                ...
                row_title1.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        // TODO Auto-generated method stub
                        iCategoryKP.onSetectedItemCategoryKP(Integer.valueOf(v.getTag().toString()));

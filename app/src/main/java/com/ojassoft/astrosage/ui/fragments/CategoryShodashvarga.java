...
public class CategoryShodashvarga extends Fragment {
    ...
    ICategoryShodashvarga iCategoryShodashvarga;
    ...
    public static CategoryShodashvarga newInstance(boolean isAdTitleAdded,int adPosition) {
        Bundle bundle = new Bundle();
        bundle.putBoolean("isAdTitleHaseBeenGivenTOTabs",isAdTitleAdded);
        bundle.putInt("localAdvertismentPosition",adPosition);
        CategoryShodashvarga appViewFragment = new CategoryShodashvarga();
        appViewFragment.setArguments(bundle);
        return appViewFragment;
    }

    public CategoryShodashvarga() {
    ...
    public void onAttach(Activity activity) {
        ...
        iCategoryShodashvarga = (ICategoryShodashvarga) activity;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        moduleNameList = getActivity().getResources().getStringArray(R.array.module_board_shodashvarga_list);
        ...
        llCustomAdv.addView(CUtils.getCustomAdvertismentView(activity, false, ((BaseInputActivity) getActivity()).mediumTypeface,"SVRGA"));
            ...
            if (categoryItem.index1 > -1) {
                ...
                row_title1.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        // TODO Auto-generated method stub
                        iCategoryShodashvarga.onSetectedItemCategoryShodashvarga(Integer.valueOf(v.getTag().toString()));

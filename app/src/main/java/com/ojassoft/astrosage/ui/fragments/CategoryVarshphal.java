...
public class CategoryVarshphal extends Fragment {
    ...
    public void onAttach(Activity activity) {
        ...
        iCategoryVarshphal = (ICategoryVarshphal) activity;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        moduleNameList = getActivity().getResources().getStringArray(R.array.module_board_varshpal_list);
        ...
        llCustomAdv.addView(CUtils.getCustomAdvertismentView(activity, false, ((BaseInputActivity) getActivity()).mediumTypeface,"SVP"));
            ...
            if (categoryItem.index1 > -1) {
                ...
                row_title1.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        // TODO Auto-generated method stub
                        iCategoryVarshphal.onSetectedItemCategoryVarshphal(Integer.valueOf(v.getTag().toString()));

...
import com.ojassoft.astrosage.customadapters.ChooseVartaExpertiseAdapter;
...
public class ChooseExpertFragmentDailog extends AstroParentFrag {
    ...
    private ChooseVartaExpertiseAdapter expertiseAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        expertiseAdapter = new ChooseVartaExpertiseAdapter(context, languageModels);
        recyclerView.setLayoutManager(new GridLayoutManager(context, 2));
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        recyclerView.setAdapter(expertiseAdapter);
    ...
    private void goToChooseLanguageOK() {
        ...
        if (TextUtils.isEmpty(sectedExperts)) {
            ((BaseInputActivity) context).showSnackbar(recyclerView, context.getString(R.string.msg_choose_expertise_title));
            return;
        }
        ...
        if(getActivity() instanceof VartaReqJoinActivity){
            ...
            ((ListingCreationActivity) getActivity()).setSelectedExperts(sectedExperts, sectedExpertssToDisplay);
        }

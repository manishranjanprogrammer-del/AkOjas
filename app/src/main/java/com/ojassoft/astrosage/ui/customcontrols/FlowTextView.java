...
public class FlowTextView extends RelativeLayout {
    ...
    private int mColor = getResources().getColor(com.ojassoft.astrosage.R.color.black);
    ...
    private void readAttrs(Context context, AttributeSet attrs) {
        ...
        mTextColor = ta.getColor(3, context.getColor(com.ojassoft.astrosage.R.color.black)); // 3 is the index of the array of the textColor attribute
        ta.recycle();
    }

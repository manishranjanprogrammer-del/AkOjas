...
public class CategoryBasic extends Fragment {

    public Integer[] moduleIconList = {R.drawable.ic_module_dasha,
    ...
    public static CategoryBasic newInstance(boolean isAdTitleAdded, int adPosition) {
        Bundle bundle = new Bundle();
        bundle.putBoolean("isAdTitleHaseBeenGivenTOTabs", isAdTitleAdded);
        bundle.putInt("localAdvertismentPosition", adPosition);
        CategoryBasic appViewFragment = new CategoryBasic();
    ...
    public void onAttach(Activity activity) {
        ...
        iCategoryBasic = (ICategoryBasic) activity;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        moduleNameList = getActivity().getResources().getStringArray(R.array.category_basic_list);
        ...
        llCustomAdv.addView(CUtils.getCustomAdvertismentView(activity, false, ((BaseInputActivity) getActivity()).mediumTypeface,"SBA"));
        ...
        refreshActivityOnLanguageChange();
        return rootView;
    }

    private void refreshActivityOnLanguageChange(){
        try{
            int currentLanguageCode = AstrosageKundliApplication.getAppContext().getLanguageCode();
            ...
            Log.d("TestLang", currentLanguageCode+" refreshActivityOnLanguageChange="+currentLocale);

            if(currentLanguageCode != 0 && currentLocale.toString().contains("en_US")) {
                //Log.d("TestLang", " restart activity");
            ...
            if (categoryItem.index1 > -1) {
                ...
                row_title1.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        // TODO Auto-generated method stub
                        iCategoryBasic.onSetectedItemCategoryBasic(Integer.valueOf(v.getTag().toString()));

                    }
                });
            } else
                row_title1.setVisibility(View.GONE);

...
public class NumerologyTimeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_numrology_time, container, false);
        initViews();
        initListner();
        return view;
    }
    ...
    private void initViews() {
        ...
        timeTV.setTypeface(((BaseInputActivity) currentActivity).regularTypeface);

        topAdImage = (NetworkImageView) view.findViewById(R.id.topAdImage);
        llCustomAdv = (LinearLayout) view.findViewById(R.id.llCustomAdv);
        llCustomAdv.addView(CUtils.getCustomAdvertismentView(currentActivity, false, ((NumerologyCalculatorOutputActivity) currentActivity).regularTypeface, "AKNTI"));
        initAdClickListner();
        topAdData = ((NumerologyCalculatorOutputActivity) currentActivity).getAddData("47");
        ...
        if (numerologyOutputModel != null) {
            timeTV.setText(numerologyOutputModel.getAuspiciousTimeDesc());
        }
    }
        ...
        topAdImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CUtils.googleAnalyticSendWitPlayServie(currentActivity,
                        ...
                        CGlobalVariables.GOOGLE_ANALYTIC_SLOT_47_Add, null);
                CUtils.fcmAnalyticsEvents(CGlobalVariables.GOOGLE_ANALYTIC_SLOT_47_Add, CGlobalVariables.FIREBASE_EVENT_ITEM_CLICK, "");

                CUtils.createSession(currentActivity, "S47");

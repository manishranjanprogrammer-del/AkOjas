...
import com.ojassoft.astrosage.customadapters.NavratraViewAdapter;
...
public class ActFestivalNavratraView extends BaseInputActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private NavratraViewAdapter mAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       /* LANGUAGE_CODE = ((AstrosageKundliApplication) getApplication())
        ...
        recyclerView = (RecyclerView) findViewById(R.id.my_nav_view_recycler_view);
        addRecyclerView();
        if (!CUtils.isConnectedWithInternet(ActFestivalNavratraView.this)) {
            MyCustomToast mct = new MyCustomToast(ActFestivalNavratraView.this, ActFestivalNavratraView.this
                    .getLayoutInflater(), ActFestivalNavratraView.this, typeface);
    ...
    private void initSwipeRefreshLayout() {
        swipeView = (SwipeRefreshLayout) findViewById(R.id.swipe_view_festival_navratra_view);
    ...
    private void getDetailFromServer(String postUrl,boolean isShowProgressBar) {
        pd = new CustomProgressDialog(ActFestivalNavratraView.this, typeface);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, postUrl,
            ...
            public Map<String, String> getParams() {
                ...
                headers.put("key", CUtils.getApplicationSignatureHashCode(ActFestivalNavratraView.this));
                headers.put("isapi", "1");
...
// Add the request to the RequestQueue.
    ...
    private void parseGsonData(String saveData) {
        try {
            ...
            if (allPanchangData.getVratFestivalApiData() != null && allDetailData != null) {
                FragmentManager fm = getSupportFragmentManager();
                mAdapter = new NavratraViewAdapter(this, allPanchangData.getVratFestivalApiData(), allDetailData);

...
public class NumerologyCareerFragment extends Fragment {
    ...
    public NumerologyCareerFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_numrology_career, container, false);
        initViews();
        initListner();
        return view;
    }
    ...
    private void initViews() {
        ...
        careerTV.setTypeface(((BaseInputActivity) currentActivity).regularTypeface);
        ...
        llCustomAdv.addView(CUtils.getCustomAdvertismentView(currentActivity, false, ((NumerologyCalculatorOutputActivity) currentActivity).regularTypeface, "AKNCA"));
        initAdClickListner();
        topAdData = ((NumerologyCalculatorOutputActivity) currentActivity).getAddData("48");
        ...
        if (numerologyOutputModel != null) {
            careerTV.setText(numerologyOutputModel.getCareerDesc());
        }
    }
        ...
        topAdImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CUtils.googleAnalyticSendWitPlayServie(currentActivity,
                        ...
                        CGlobalVariables.GOOGLE_ANALYTIC_SLOT_48_Add, null);
                CUtils.fcmAnalyticsEvents(CGlobalVariables.GOOGLE_ANALYTIC_SLOT_48_Add, CGlobalVariables.FIREBASE_EVENT_ITEM_CLICK, "");

                CUtils.createSession(currentActivity, "S48");

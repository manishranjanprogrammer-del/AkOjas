...
public class CategoryDasha extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        moduleNameList = getActivity().getResources().getStringArray(R.array.module_board_prediction_list);
        moduleNameList[1] = getActivity().getResources().getString(R.string.home_predictions);
        ...
        llCustomAdv.addView(CUtils.getCustomAdvertismentView(activity, false, ((BaseInputActivity) getActivity()).mediumTypeface,"SDSHA"));

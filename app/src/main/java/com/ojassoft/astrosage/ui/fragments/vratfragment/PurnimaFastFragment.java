...
public class PurnimaFastFragment extends Fragment implements OnRefreshListener {
    ...
    public static Fragment newInstance(String panchang) {
        ...
        PurnimaFastFragment f = new PurnimaFastFragment();
        Bundle b = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.purnima_fast_fragment, container, false);
        mRecyclerView = (RecyclerView) view.findViewById(R.id.my_purnima_recycler_view);

        tvPlace = (TextView) view.findViewById(R.id.textViewPlaceName);
        ...
        // BeanPlace chekDefault=CUtils.getUserDefaultCityForVrat(activity);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                setPlaceDataView();
                ((ActYearlyVrat) activity).downloadDataWhenChangeInDate(CGlobalVariables.purnimaVratUrl, ((ActYearlyVrat) activity).year, (((ActYearlyVrat) activity)).cityId, true);
                //downloadDataWhenChangeInDate(((ActYearlyVrat) activity).year, (((ActYearlyVrat) activity).beanPlace).getCityId());
        ...
        topAdImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CUtils.googleAnalyticSendWitPlayServie(activity,
                        ...
                        CGlobalVariables.GOOGLE_ANALYTIC_SLOT_54_Add, null);
                CUtils.fcmAnalyticsEvents(CGlobalVariables.GOOGLE_ANALYTIC_SLOT_54_Add, CGlobalVariables.FIREBASE_EVENT_ITEM_CLICK, "");

                CUtils.createSession(activity, "S54");
    ...
    private void getData() {
        ...
        try {
            ...
            if (result != null && !result.equals("")) {
                ...
                topAdData = CUtils.getSlotData(adList, "54");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        switch (requestCode) {
            case SUB_ACTIVITY_PLACE_SEARCH:
                if (resultCode == activity.RESULT_OK) {
                    ...
                    // isChecked = CUtils.getUsersCheckedDefaultCityForVrat(activity);
                    //downloadDataWhenChangeInDate(((ActYearlyVrat) activity).year, (((ActYearlyVrat) activity).beanPlace).getCityId());
                    ((ActYearlyVrat) activity).downloadDataWhenChangeInDate(CGlobalVariables.purnimaVratUrl, ((ActYearlyVrat) activity).year, cityId, true);
    ...
    private void setPlaceDataView() {
        ...
        if (((ActYearlyVrat) activity).beanPlace != null &&
                ((ActYearlyVrat) activity).beanPlace.getCountryName() != null &&
                ((ActYearlyVrat) activity).beanPlace.getCountryName().trim().equalsIgnoreCase("Nepal")) {
        ...
        if (((ActYearlyVrat) activity).beanPlace != null &&
                ((ActYearlyVrat) activity).beanPlace.getCountryName() != null && ((ActYearlyVrat) activity).beanPlace.getCountryName().trim().equalsIgnoreCase("Suriname")) {
    ...
    public void onRefresh() {
        ...
        ((ActYearlyVrat) activity).downloadDetails(CGlobalVariables.purnimaVratUrl, ((ActYearlyVrat) activity).year, (((ActYearlyVrat) activity)).cityId, false);

 ...
 */
public class FragNavagrah extends Fragment {
    private RecyclerView mRecyclerView;
    public RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mLayoutManager;
    //   private ArrayList<AstroShopData> arrayListdata;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        data = ((ActAstroShop) getActivity()).data.get(3);
        if (data != null && data.getNavagrahYantras().size() > 0) {

            arrayListdata = data.getNavagrahYantras();

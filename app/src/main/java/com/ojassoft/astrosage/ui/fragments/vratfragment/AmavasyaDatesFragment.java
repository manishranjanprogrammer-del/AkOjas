...
public class AmavasyaDatesFragment extends Fragment implements OnRefreshListener {
    ...
    public static Fragment newInstance(String panchang) {
        ...
        AmavasyaDatesFragment f = new AmavasyaDatesFragment();
        Bundle b = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.amavasya_dates_fragment, container, false);
        mRecyclerView = (RecyclerView) view.findViewById(R.id.my_amavasya_recycler_view);
       ...
       /* beanHoroPersonalInfo = new BeanHoroPersonalInfo();
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((ActYearlyVrat) activity).downloadDataWhenChangeInDate(CGlobalVariables.amavasyaVratUrl, ((ActYearlyVrat) activity).year, (((ActYearlyVrat) activity)).cityId, true);
        ...
        topAdImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CUtils.googleAnalyticSendWitPlayServie(activity,
                        ...
                        CGlobalVariables.GOOGLE_ANALYTIC_SLOT_58_Add, null);
                CUtils.fcmAnalyticsEvents(CGlobalVariables.GOOGLE_ANALYTIC_SLOT_58_Add, CGlobalVariables.FIREBASE_EVENT_ITEM_CLICK, "");

                CUtils.createSession(activity, "S58");
    ...
    private void getData() {
        ...
        try {
            ...
            if (result != null && !result.equals("")) {
                ...
                topAdData = CUtils.getSlotData(adList, "58");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        switch (requestCode) {
            case SUB_ACTIVITY_PLACE_SEARCH:
                if (resultCode == activity.RESULT_OK) {
                    ...
                    //isChecked = CUtils.getUsersCheckedDefaultCityForVrat(activity);
                    //downloadDataWhenChangeInDate(((ActYearlyVrat) activity).year, (((ActYearlyVrat) activity).beanPlace).getCityId());
                    ((ActYearlyVrat) activity).downloadDataWhenChangeInDate(CGlobalVariables.amavasyaVratUrl, ((ActYearlyVrat) activity).year, cityId, true);
    ...
    public void onRefresh() {
        ...
        ((ActYearlyVrat) activity).downloadDetails(CGlobalVariables.amavasyaVratUrl, ((ActYearlyVrat) activity).year, (((ActYearlyVrat) activity)).cityId, false);

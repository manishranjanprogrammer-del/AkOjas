...
public class NumerologyFastFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_numrology_fast, container, false);
        initViews();
        initListner();
        return view;
    }
    ...
    private void initViews() {
        ...
        fastTV = view.findViewById(R.id.fastTV);
        lblHeadingTV = view.findViewById(R.id.lblHeadingTV);
        fastTV.setTypeface(((BaseInputActivity) currentActivity).regularTypeface);
        ...
        llCustomAdv.addView(CUtils.getCustomAdvertismentView(currentActivity, false, ((NumerologyCalculatorOutputActivity) currentActivity).regularTypeface, "AKNFA"));
        initAdClickListner();
        topAdData = ((NumerologyCalculatorOutputActivity) currentActivity).getAddData("49");
        ...
        if (numerologyOutputModel != null) {
            fastTV.setText(numerologyOutputModel.getFastsRemediesDesc());
        }
    }
        ...
        topAdImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CUtils.googleAnalyticSendWitPlayServie(currentActivity,
                        ...
                        CGlobalVariables.GOOGLE_ANALYTIC_SLOT_49_Add, null);
                CUtils.fcmAnalyticsEvents(CGlobalVariables.GOOGLE_ANALYTIC_SLOT_49_Add, CGlobalVariables.FIREBASE_EVENT_ITEM_CLICK, "");

                CUtils.createSession(currentActivity, "S49");

...
public class NumerologyHealthFragment extends Fragment {
    ...
    public NumerologyHealthFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_numrology_health, container, false);
        initViews();
        initListner();
        return view;
    }
    ...
    private void initViews() {
        ...
        healthTV.setTypeface(((BaseInputActivity) currentActivity).regularTypeface);
        ...
        llCustomAdv.addView(CUtils.getCustomAdvertismentView(currentActivity, false, ((NumerologyCalculatorOutputActivity) currentActivity).regularTypeface, "AKNHE"));
        initAdClickListner();
        topAdData = ((NumerologyCalculatorOutputActivity) currentActivity).getAddData("46");
        ...
        if (numerologyOutputModel != null) {
            healthTV.setText(numerologyOutputModel.getHealthDesc());
        }
        ...
        topAdImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CUtils.googleAnalyticSendWitPlayServie(currentActivity,
                        ...
                        CGlobalVariables.GOOGLE_ANALYTIC_SLOT_46_Add, null);
                CUtils.fcmAnalyticsEvents(CGlobalVariables.GOOGLE_ANALYTIC_SLOT_46_Add, CGlobalVariables.FIREBASE_EVENT_ITEM_CLICK, "");

                CUtils.createSession(currentActivity, "S46");

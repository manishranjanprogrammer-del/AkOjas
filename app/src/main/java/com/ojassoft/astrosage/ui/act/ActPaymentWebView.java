...
public class ActPaymentWebView extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        LANGUAGE_CODE = ((AstrosageKundliApplication) ActPaymentWebView.this.getApplication())
                .getLanguageCode();

        typeface = CUtils.getRobotoFont(
                ActPaymentWebView.this, LANGUAGE_CODE, CGlobalVariables.regular);
        mainIntent = getIntent();
        pd = new CustomProgressDialog(ActPaymentWebView.this, typeface);
        init();
        getData();
  ...
  /*  private class RenderView extends AsyncTask<Void, Void, Void> {
            ...
            class MyJavaScriptInterface {
                ...
                public void processHTML(String html) {
                    ...
                    if (html.indexOf("Failure") != -1) {
                        ...
                        CUtils.googleAnalyticSendWitPlayServie(ActPaymentWebView.this, CGlobalVariables.GOOGLE_ANALYTIC_EVENT, "SERVICE_PURCHASED", null);
    ...
    private void init() {
        ...
        orderModel = (AstrologerServiceInfo) mainIntent.getSerializableExtra("Order_Model");
...
// Request a string response from the provided URL.
        StringRequest stringRequest = new StringRequest(Request.Method.POST, CGlobalVariables.postservicepaystatus,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (result.equalsIgnoreCase("1")) {
                                Intent intent = new Intent(ActPaymentWebView.this, ActServicePaymentStatus.class);
            ...
            public Map<String, String> getParams() throws AuthFailureError {
                ...
                headers.put("key", CUtils.getApplicationSignatureHashCode(ActPaymentWebView.this));
                headers.put("amount", amount);
                headers.put("orderid", order_id);
                headers.put("paycurr", currency);
                headers.put("status", payStatus);
                if (orderModel.getProfileId() == null) {
                    headers.put("profile_Id", "");
                } else {
                    headers.put("profile_Id", orderModel.getProfileId());
                }
...
// Add the request to the RequestQueue.
    ...
    public void onPurchaseCompleted(ServicelistModal itemdetails, AstrologerServiceInfo orderModel, String order_id) {
        //Log.e("Purchase plan Start","");
       /* Transaction myTrans = new Transaction.Builder(
                order_id,                                           // (String) Transaction Id, should be unique.
                (long) (Double.valueOf(orderModel.getPriceRs()) * 1000000))                              // (long) Order total (in micros)
                .setAffiliation("In-App Store")                       // (String) Affiliation
                .setTotalTaxInMicros((long) (0))         // (long) Total tax (in micros)
                .setShippingCostInMicros((long)(0))
                .setCurrencyCode("INR")// (long) Total shipping cost (in micros)
                .build();

        myTrans.addItem(new Transaction.Item.Builder(
                itemdetails.getServiceId(),                                              // (String) Product SKU
                itemdetails.getTitle(),                                  // (String) Product name
                (long) (Double.valueOf(orderModel.getPriceRs()) * 1000000),                              // (long) Product price (in micros)
                (long) 1)                                             // (long) Product quantity
                .setProductCategory("Astro Services")
        ...
        //double price = (Double.valueOf(orderModel.getPriceRs()));
        CUtils.trackEcommerceProduct(ActPaymentWebView.this, itemdetails.getServiceId(), itemdetails.getTitle(), orderModel.getPriceRs(), order_id, "INR", "Astro Services", "In-App Store", "0", CGlobalVariables.TOPIC_PRODUCTS);

...
public class FragGridView extends Fragment {
    private ScrollableGridView grid_view;
    private View view;
      ...
      /*  } else {
        ...
        */
        ...
        /*if (act != null && ((ActAstroShop) act).sliderList != null && ((ActAstroShop) act).sliderList.size() > 0) {
            setCustomAdd(((ActAstroShop) act).sliderList);
        }*/
        ...
        grid_view = (ScrollableGridView) view.findViewById(R.id.grid_view);
    ...
    public static FragGridView newInstance(JSONArray text, int pos) {
        //Toast.makeText(activity, text, Toast.LENGTH_SHORT).show();
        FragGridView f = new FragGridView();
        Bundle b = new Bundle();

...
public class RatingReviews extends FrameLayout {
    ...
    private void draw(int dimension, Bar initialBar, final Bar bar, final View view) {
        ...
        view.post(new Runnable() {
            ...
            public void run() {
                ...
                if (bar.isGradientBar()) {
                    ...
                    if (isRoundCorner) {
                        view.findViewById(R.id.linear_bar).setBackground(Utils.getRoundedBarGradientDrawable(bar.getStartColor(), bar.getEndColor(), radius));
                        view.findViewById(R.id.bar_color_code).setBackground(Utils.getRoundedBarGradientDrawable(bar.getStartColor(), bar.getEndColor(), radius));
                    } else {
                        ...
                        view.findViewById(R.id.bar_color_code).setBackground(gradientDrawable);
                    }
                } else {
                    if (isRoundCorner) {
                        view.findViewById(R.id.linear_bar).setBackground(Utils.getRoundedBarDrawable(bgColor, radius));
                        view.findViewById(R.id.bar_color_code).setBackground(Utils.getRoundedBarDrawable(bgColor, radius));
                    } else {
                        view.findViewById(R.id.linear_bar).setBackgroundColor(bgColor);
                        view.findViewById(R.id.bar_color_code).setBackgroundColor(bgColor);
                    }
                }
            }
        });
        ...
        if (isShowLabel) {
            ...
            textView.setTypeface(((BaseInputActivity)mCtx).regularTypeface);
        } else {

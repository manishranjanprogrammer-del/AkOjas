...
/**
 * Created by chandan on 24/8/16.
 */

public class RoundPic extends ImageView {
    ...
    public RoundPic(final Context context) {
        this(context, null);
    }

    public RoundPic(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundPic(Context context, AttributeSet attrs, int defStyleAttr) {

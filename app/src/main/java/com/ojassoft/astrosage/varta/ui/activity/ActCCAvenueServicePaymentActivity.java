...
import com.ojassoft.astrosage.varta.utils.Constants;
import com.ojassoft.astrosage.varta.utils.CustomProgressDialog;
import com.ojassoft.astrosage.varta.utils.RSAUtility;
import com.ojassoft.astrosage.varta.utils.ServiceUtility;
...
public class ActCCAvenueServicePaymentActivity extends Activity {
    ...
    private void renderView(String response) {
        ...
        params.append(ServiceUtility.addToPostParams(AvenuesParams.MERCHANT_PARAM1, BuildConfig.APPLICATION_ID));//package
        params.append(ServiceUtility.addToPostParams(AvenuesParams.MERCHANT_PARAM2, BuildConfig.VERSION_NAME));//version
        params.append(ServiceUtility.addToPostParams(AvenuesParams.MERCHANT_PARAM3, "service"));//ordertype
        params.append(ServiceUtility.addToPostParams(AvenuesParams.MERCHANT_PARAM4, ""));//chatid
        if (encVal != null)

...
public class CustomCitySearch extends Fragment implements VolleyResponse {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.customcitysearchfraglayout_varta, container, false);
    ...
    private void setLayRef(View view) {
      ...
      //  butPlaceCustomOk.setTypeface(((ActPlaceSearch) getActivity()).regularTypeface);
        ...
        /*if (((KundalisoftwareApplication) getActivity().getApplication())
        ...
        try {
            ...
            adapter = new ArrayAdapter<String>(getActivity(), R.layout.spinner_list_item, listTimeZone) {
                ...
                public View getView(int position, View convertView, ViewGroup parent) {
                   ...
                   // ((TextView)v).setTextSize(getResources().getDimension(R.dimen.spinner_text_size));
    ...
    private boolean validateName(EditText name, TextInputLayout inputLayout, String message) {
        ...
        if (name == editTxtVLatDeg) {
            if (name.getText().toString().trim().isEmpty()) {
                ...
                requestFocus(name);
                name.getBackground().setColorFilter(getResources().getColor(R.color.colorPurple), PorterDuff.Mode.SRC_ATOP);
                value = false;
    ...
    public void onResponse(String response, int method) {
        Log.e("CCSTest 2", " onResponse " + response);
        try {
            if (getActivity() != null) {
            ...
            if (getActivity() != null) {
                CUtils.showSnackbar(editTxtVLatDeg, getActivity().getResources().getString(

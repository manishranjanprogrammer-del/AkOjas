...
public class PaymentProcessDialog extends DialogFragment implements View.OnClickListener {
    Activity activity;
    TextView oopsTV, rechargeUnsuccessfulTV, descTV, amountTV;
    Button doneBtn;
    String rechargeMount;

    public PaymentProcessDialog(){

    }

    public PaymentProcessDialog(String rechargeMount) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.payment_process_layout, container);

...
import com.ojassoft.astrosage.varta.adapters.SearchViewPagerAdapter;
import com.ojassoft.astrosage.varta.interfacefile.ICitySearch;
import com.ojassoft.astrosage.varta.model.BeanPlace;
import com.ojassoft.astrosage.varta.ui.fragments.CitySearchFrag;
import com.ojassoft.astrosage.varta.ui.fragments.CustomCitySearch;
import com.ojassoft.astrosage.varta.ui.fragments.GPSCitySearch;
 ...
 * @date 18 feb 2014
 */
public class ActPlaceSearch extends BaseActivity implements ICitySearch {
    /**
     * Local Variables
     */
    ...
    final LinearLayout llPlaceSearch = null;
    GPSCitySearch gpsCitySearch;
    LinearLayout backTitleLayout;
    RelativeLayout vartaIconLayout, walletBoxLayout;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toolBar_search_place = (Toolbar) findViewById(R.id.toolbar);
        tvToolBarTitle = (TextView) toolBar_search_place
                .findViewById(R.id.tvTitle);
        ivToggleImage = (ImageView) findViewById(R.id.ivBack);
       ...
       /* ActionBar actionBar = getSupportActionBar();
        ...
        actionBar.setHomeAsUpIndicator(R.drawable.ic_keyboard_arrow_left_black);*/
        ...
        /*LANGUAGE_CODE = ((KundalisoftwareApplication) getApplication())
...
//		RelativeLayout.LayoutParams paramsViewPager = (RelativeLayout.LayoutParams) mViewPager.getLayoutParams();
//		paramsViewPager.addRule(RelativeLayout.BELOW, tabLayout.getId());
//		mViewPager.setLayoutParams(paramsViewPager);
        ...
        // CUtils.showAdvertisement(ActPlaceSearch.this,(LinearLayout)
        // findViewById(R.id.advLayout));
        ...
        for (int j = 0; j < tabsCount; j++) {
            ...
            for (int i = 0; i < tabChildsCount; i++) {
                ...
                if (tabViewChild instanceof TextView) {
                    FontUtils.changeFont(this, ((TextView) tabViewChild), CGlobalVariables.FONTS_OPEN_SANS_BOLD);
                }
            }
        }
    }
    ...
    private void setupViewPager() {
        ...
        final SearchViewPagerAdapter adapter = new SearchViewPagerAdapter(getSupportFragmentManager(), ActPlaceSearch.this);
    ...
    private void showLocationAccessSettingActivity() {
        try {
            ...
            e.printStackTrace();
            CUtils.showSnackbar(tvToolBarTitle, "Your device does not support GPS", ActPlaceSearch.this);
	...
	public String executeTimezoneHttpGet(double lat, double lon)
		...
		String _url = "lat="
				...
				+ "&username=fleshearth";
		// String
		// _url=""+String.valueOf(lat)+"&lng="+String.valueOf(lon)+"&username=hukumsingh87";
		try {
	...
	/*	typeface = CUtils.getUserSelectedLanguageFontType(
        ...
        setScreenTitle(null, getResources()
...
/*	private void fetchCityDetailFromDatabase(int cityId) {
    ...
    private void setScreenTitle(Typeface typeface, String title) {
        ...
        FontUtils.changeFont(this, tvToolBarTitle, CGlobalVariables.FONTS_OPEN_SANS_SEMIBOLD);

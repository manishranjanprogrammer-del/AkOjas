...
public class AIGridViewAstrologerAdapter  extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AIGridViewAstrologerAdapter(Context context, final LoadMoreList loadMoreListInterface, ArrayList<AstrologerDetailBean> arrayListRecyclerView) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.ai_astrologer_grid_layout, parent, false);
        return new AIGridViewAstrologerAdapter.ItemViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final RecyclerView.ViewHolder holder1, int position) {

        if (holder1 instanceof AIGridViewAstrologerAdapter.ItemViewHolder) {

            AIGridViewAstrologerAdapter.ItemViewHolder holder = (AIGridViewAstrologerAdapter.ItemViewHolder) holder1;
            ...
            if (astrologerDetailBean.getImageFile() != null && astrologerDetailBean.getImageFileLarge().length() > 0) {
                astrologerProfileUrl = CGlobalVariables.IMAGE_DOMAIN + astrologerDetailBean.getImageFileLarge();
                Glide.with(context.getApplicationContext()).load(astrologerProfileUrl).diskCacheStrategy(DiskCacheStrategy.ALL).into(holder.imgViewAstrologerLarge);
            }

               // astrologerDetailBean.setIsAvailableForCall("fasle");
            if (astrologerDetailBean.isAvailableForChatBool() && astrologerDetailBean.isAvailableForCallBool()) {
                holder.callChatBtnLayout.setVisibility(View.VISIBLE);
                holder.chatOnlyBtn.setVisibility(View.GONE);
                ...
                holder.callChatBtnLayout.setVisibility(View.GONE);

                holder.chatOnlyBtn.setVisibility(View.VISIBLE);

                if (astrologerDetailBean.getIsBusy().equalsIgnoreCase("true")) {
                    holder.chatOnlyBtn.setText(context.getResources().getString(R.string.busy));
                    holder.chatOnlyBtn.setBackgroundResource(R.drawable.bg_button_red);
                    holder.chatOnlyBtn.setTextColor(Color.WHITE);
                } else {
                    holder.chatOnlyBtn.setText(context.getResources().getString(R.string.chat_now));
                    holder.chatOnlyBtn.setBackgroundResource(R.drawable.bg_button_yellow);
                    holder.chatOnlyBtn.setTextColor(ActivityCompat.getColor(context, R.color.white));
                }
            }else{
                holder.callChatBtnLayout.setVisibility(View.GONE);
                ...
                holder.chatOnlyBtn.setText(context.getResources().getString(R.string.chat_now));
                holder.chatOnlyBtn.setBackgroundResource(R.drawable.bg_button_yellow);
                holder.chatOnlyBtn.setTextColor(context.getColor(R.color.white));
            }
            ...
            holder.tetViewExpertise.setText(astrologerDetailBean.getProfileTitle());
...
//                holder.ruppee_sign.setVisibility(View.GONE);
                ...
                holder.chatNowBtn.setTextSize(15);
                holder.chatNowBtn.setPadding(5,10,5,10);
                holder.callNowBtn.setTextSize(15);
                holder.callNowBtn.setPadding(5,10,5,10);
                if(holder.chatOnlyBtn.getVisibility()==View.VISIBLE){
                    holder.chatOnlyBtn.setPadding(15,10,15,10);
                    holder.chatOnlyBtn.setText(context.getResources().getString(R.string.free_chat_now));
                    FontUtils.changeFont(context, holder.chatOnlyBtn, CGlobalVariables.FONTS_OPEN_SANS_BOLD);
                    holder.chatOnlyBtn.setTextSize(14);
                }
                ...
                if (astrologerDetailBean.getUseIntroOffer()) {
                    ...
                    if (astrologerDetailBean.isFreeForChat()) {
                        if (!TextUtils.isEmpty(offerType) && offerType.equals(CGlobalVariables.INTRO_OFFER_TYPE_FREE)) {
                            ...
                            holder.chatNowBtn.setText(context.getResources().getString(R.string.chat_now));
                            holder.chatOnlyBtn.setText(context.getResources().getString(R.string.chat_now));
                            // in case of free offer, hide call button
//                            holder.callChatBtnLayout.setVisibility(View.VISIBLE);
//                            holder.chatOnlyBtn.setVisibility(View.VISIBLE);
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView ratingTxt, ratingTxtTotal, chatNowBtn,callNowBtn, chatOnlyBtn, questionPriceTxt,
                vedicAstrologerTxt,tetViewExpertise, languageTxt, astrologerNameTxt, actualQuestionPriceTxt,
                ruppee_sign, newUser, followersCountTV, tvExp;
        ImageView ratingTxtTotalImg;
        NetworkImageView verifiedImg;
        RelativeLayout mainLayout;
        LinearLayout callChatBtnLayout;
        ImageView onlineOfflineImg, ratingStar,imgViewAstrologerLarge;
        CardView upperLayout;
        ImageView progressBarIV;

        public ItemViewHolder(View itemView) {
            super(itemView);
            imgViewAstrologerLarge = itemView.findViewById(R.id.imgViewAstrologerLarge);
            ...
            callChatBtnLayout = itemView.findViewById(R.id.call_chat_btn_layout);
            chatNowBtn = itemView.findViewById(R.id.chat_now_btn);
            callNowBtn = itemView.findViewById(R.id.call_now_btn);
            chatOnlyBtn = itemView.findViewById(R.id.chat_only_btn);
            ...
            tetViewExpertise = itemView.findViewById(R.id.tetViewExpertise);
            ...
            FontUtils.changeFont(context, astrologerNameTxt, CGlobalVariables.FONTS_OPEN_SANS_BOLD);
            FontUtils.changeFont(context, tetViewExpertise, CGlobalVariables.FONTS_OPEN_SANS_BOLD);
            FontUtils.changeFont(context, ratingTxt, CGlobalVariables.FONTS_OPEN_SANS_BOLD);
            FontUtils.changeFont(context, ratingTxtTotal, CGlobalVariables.FONTS_OPEN_SANS_BOLD);
            FontUtils.changeFont(context, followersCountTV, CGlobalVariables.FONTS_OPEN_SANS_BOLD);
            ...
            FontUtils.changeFont(context, questionPriceTxt, CGlobalVariables.FONTS_OPEN_SANS_BOLD);
            ...
            FontUtils.changeFont(context, vedicAstrologerTxt, CGlobalVariables.FONTS_POPPINS_REGULAR);
            FontUtils.changeFont(context, languageTxt, CGlobalVariables.FONTS_POPPINS_REGULAR);
            ...
            chatNowBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        CUtils.fcmAnalyticsEvents("ai_chat_btn_click_astrologer_grid", AstrosageKundliApplication.currentEventType, "");
            ...
            callNowBtn.setOnClickListener((v)->{
                try {
                    ...
                    CUtils.fcmAnalyticsEvents("ai_call_btn_click_astrologer_grid", AstrosageKundliApplication.currentEventType, "");
                    ...
                    if (isLogin) {
                        ...
                        astrologerDetailBean.setCallSource(CGlobalVariables.AI_GRID_VIEW_CALL_BTN);
            ...
            chatOnlyBtn.setOnClickListener((v)->{ chatNowBtn.callOnClick();});
        }
